...
async function sharpTransform(original, action, minimizerOptions = {}, targetFormat = null) {
  ...
  const info = action === 0 ? { ...original.info,
    minimized: true,
    minimizedBy: original.info && original.info.generatedBy ? ["sharp", ...original.info.generatedBy] : ["sharp"]
  } : { ...original.info,
    generated: true,
...
function sharpGenerate(original, minimizerOptions) {
  ...
  const targetFormats =
  /** @type {SharpFormat[]} */
  Object.keys((_squooshOptions$encod = squooshOptions.encodeOptions) !== null && _squooshOptions$encod !== void 0 ? _squooshOptions$encod : {});
